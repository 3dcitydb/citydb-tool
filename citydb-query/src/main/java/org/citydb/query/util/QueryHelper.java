...
public class QueryHelper {
    ...
    public static Query getNonTerminatedTopLevelFeatures() {
        return new Query().setFilter(Filter.of(terminationDateIsNull()));
    }

    public static BooleanExpression terminationDateIsNull() {
