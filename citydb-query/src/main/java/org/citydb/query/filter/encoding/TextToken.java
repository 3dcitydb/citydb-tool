...
public enum TextToken {
    ...
    static final EnumSet<TextToken> SPATIAL_OPERATORS = EnumSet.of(S_INTERSECTS, S_EQUALS, S_DISJOINT, S_TOUCHES,
            S_WITHIN, S_OVERLAPS, S_CROSSES, S_CONTAINS, S_DWITHIN, S_BEYOND);
