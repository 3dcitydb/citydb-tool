...
public class TunnelPartPropertyAdapter extends AbstractInlineOrByReferencePropertyAdapter<TunnelPartProperty> {

    @Override
    public TunnelPartProperty createObject(FeatureProperty source) throws ModelSerializeException {
