...
@DatabaseType(name = "Railway", namespace = Namespaces.TRANSPORTATION)
public class RailwayAdapter extends AbstractTransportationSpaceAdapter<Railway> {

    @Override
    public Feature createModel(Railway source) throws ModelBuildException {
        return Feature.of(FeatureType.RAILWAY);
    }

    @Override
    public void build(Railway source, Feature target, ModelBuilderHelper helper) throws ModelBuildException {
    ...
    @Override
    public Railway createObject(Feature source) throws ModelSerializeException {
        return new Railway();
    }

    @Override
    public void serialize(Feature source, Railway target, ModelSerializerHelper helper) throws ModelSerializeException {
