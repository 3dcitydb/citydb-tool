...
@DatabaseType(name = "BuildingFurniture", namespace = Namespaces.BUILDING)
public class BuildingFurnitureAdapter extends AbstractFurnitureAdapter<BuildingFurniture> {

    @Override
    public Feature createModel(BuildingFurniture source) throws ModelBuildException {
        return Feature.of(FeatureType.BUILDING_FURNITURE);
    }

    @Override
    public void build(BuildingFurniture source, Feature target, ModelBuilderHelper helper) throws ModelBuildException {
        super.build(source, target, helper);
        helper.addStandardObjectClassifiers(source, target, Namespaces.BUILDING);

        if (source.hasDeprecatedProperties()) {
            DeprecatedPropertiesOfBuildingFurniture properties = source.getDeprecatedProperties();
    ...
    @Override
    public BuildingFurniture createObject(Feature source) throws ModelSerializeException {
        return new BuildingFurniture();
    }

    @Override
    public void serialize(Feature source, BuildingFurniture target, ModelSerializerHelper helper) throws ModelSerializeException {
        super.serialize(source, target, helper);
        helper.addStandardObjectClassifiers(source, target, Namespaces.BUILDING);
    }

    @Override
    public void postSerialize(Feature source, BuildingFurniture target, ModelSerializerHelper helper) throws ModelSerializeException {
