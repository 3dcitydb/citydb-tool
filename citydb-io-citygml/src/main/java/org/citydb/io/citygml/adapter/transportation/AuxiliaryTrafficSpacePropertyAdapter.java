...
public class AuxiliaryTrafficSpacePropertyAdapter extends AbstractInlineOrByReferencePropertyAdapter<AuxiliaryTrafficSpaceProperty> {

    @Override
    public AuxiliaryTrafficSpaceProperty createObject(FeatureProperty source) throws ModelSerializeException {
