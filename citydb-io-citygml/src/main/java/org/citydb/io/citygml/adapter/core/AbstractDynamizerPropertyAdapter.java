...
public class AbstractDynamizerPropertyAdapter extends AbstractInlineOrByReferencePropertyAdapter<AbstractDynamizerProperty> {

    @Override
    public AbstractDynamizerProperty createObject(FeatureProperty source) throws ModelSerializeException {
