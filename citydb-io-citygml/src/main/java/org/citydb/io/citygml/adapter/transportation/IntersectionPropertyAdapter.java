...
public class IntersectionPropertyAdapter extends AbstractInlineOrByReferencePropertyAdapter<IntersectionProperty> {

    @Override
    public IntersectionProperty createObject(FeatureProperty source) throws ModelSerializeException {
