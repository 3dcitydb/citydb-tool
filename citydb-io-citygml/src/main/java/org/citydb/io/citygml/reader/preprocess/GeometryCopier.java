...
public class GeometryCopier {
    ...
    GeometryCopier withAppearanceHelper(AppearanceHelper appearanceHelper) {
        this.appearanceHelper = appearanceHelper;
        return this;
    }

    GeometryCopier copyAppearance(boolean copyAppearance) {
    ...
    AbstractGeometry copy(AbstractGeometry geometry, GMLObject target, CopySession session) {
        return copy(geometry, getTopLevelObject(target), session);
    }

    AbstractGeometry copy(AbstractGeometry geometry, CopySession session) {
