...
public class HolePropertyAdapter extends AbstractInlineOrByReferencePropertyAdapter<HoleProperty> {

    @Override
    public HoleProperty createObject(FeatureProperty source) throws ModelSerializeException {
