...
public class TunnelInstallationPropertyAdapter extends AbstractInlineOrByReferencePropertyAdapter<TunnelInstallationProperty> {

    @Override
    public TunnelInstallationProperty createObject(FeatureProperty source) throws ModelSerializeException {
