...
public class TilingOptions {
    ...
    public static TilingOptions of(Envelope extent, TilingScheme scheme) {
        return new TilingOptions().setExtent(extent).setScheme(scheme);
    }
    ...
    public TilingOptions setExtent(Envelope extent) {
        this.extent = extent;
        return this;
    }
    ...
    public TilingOptions setScheme(TilingScheme scheme) {
        this.scheme = scheme;
        return this;
    }
    ...
    public TilingOptions setTileMatrixOrigin(TileMatrixOrigin tileMatrixOrigin) {
