...
INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (6, null, 'URI', 0, 1, '{"identifier":"core:URI","description":"A URI (Uniform Resource Identifier) is a string to uniquely identify a resource, either by its location, name, or both, in a standardized format.","table":"property","value":{"column":"val_uri","type":"uri"}}');
...
INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (22, null, 'StringOrRef', 0, 1, '{"identifier":"core:StringOrRef","description":"StringOrRef is a basic type that represents either a simple string or a reference to a remote string value.","table":"property","value":{"column":"val_string","type":"string"},"properties":[{"name":"href","namespace":"http://3dcitydb.org/3dcitydb/core/5.0","description":"Specifies the reference to a remote string value.","value":{"column":"val_uri","type":"uri"}}]}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (23, null, 'ADEOfAbstractCityObject', 1, 1, '{"identifier":"core:ADEOfAbstractCityObject","description":"ADEOfAbstractCityObject acts as a hook to define properties within an ADE that are to be added to AbstractCityObject.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (24, null, 'ADEOfAbstractDynamizer', 1, 1, '{"identifier":"core:ADEOfAbstractDynamizer","description":"ADEOfAbstractDynamizer acts as a hook to define properties within an ADE that are to be added to AbstractDynamizer.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (25, null, 'ADEOfAbstractFeature', 1, 1, '{"identifier":"core:ADEOfAbstractFeature","description":"ADEOfAbstractFeature acts as a hook to define properties within an ADE that are to be added to AbstractFeature.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (26, null, 'ADEOfAbstractFeatureWithLifespan', 1, 1, '{"identifier":"core:ADEOfAbstractFeatureWithLifespan","description":"ADEOfAbstractFeatureWithLifespan acts as a hook to define properties within an ADE that are to be added to AbstractFeatureWithLifespan.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (27, null, 'ADEOfAbstractLogicalSpace', 1, 1, '{"identifier":"core:ADEOfAbstractLogicalSpace","description":"ADEOfAbstractLogicalSpace acts as a hook to define properties within an ADE that are to be added to AbstractLogicalSpace.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (28, null, 'ADEOfAbstractOccupiedSpace', 1, 1, '{"identifier":"core:ADEOfAbstractOccupiedSpace","description":"ADEOfAbstractOccupiedSpace acts as a hook to define properties within an ADE that are to be added to AbstractOccupiedSpace.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (29, null, 'ADEOfAbstractPhysicalSpace', 1, 1, '{"identifier":"core:ADEOfAbstractPhysicalSpace","description":"ADEOfAbstractPhysicalSpace acts as a hook to define properties within an ADE that are to be added to AbstractPhysicalSpace.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (30, null, 'ADEOfAbstractPointCloud', 1, 1, '{"identifier":"core:ADEOfAbstractPointCloud","description":"ADEOfAbstractPointCloud acts as a hook to define properties within an ADE that are to be added to AbstractPointCloud.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (31, null, 'ADEOfAbstractSpace', 1, 1, '{"identifier":"core:ADEOfAbstractSpace","description":"ADEOfAbstractSpace acts as a hook to define properties within an ADE that are to be added to AbstractSpace.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (32, null, 'ADEOfAbstractSpaceBoundary', 1, 1, '{"identifier":"core:ADEOfAbstractSpaceBoundary","description":"ADEOfAbstractSpaceBoundary acts as a hook to define properties within an ADE that are to be added to AbstractSpaceBoundary.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (33, null, 'ADEOfAbstractThematicSurface', 1, 1, '{"identifier":"core:ADEOfAbstractThematicSurface","description":"ADEOfAbstractThematicSurface acts as a hook to define properties within an ADE that are to be added to AbstractThematicSurface.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (34, null, 'ADEOfAbstractUnoccupiedSpace', 1, 1, '{"identifier":"core:ADEOfAbstractUnoccupiedSpace","description":"ADEOfAbstractUnoccupiedSpace acts as a hook to define properties within an ADE that are to be added to AbstractUnoccupiedSpace.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (35, null, 'ADEOfAbstractVersion', 1, 1, '{"identifier":"core:ADEOfAbstractVersion","description":"ADEOfAbstractVersion acts as a hook to define properties within an ADE that are to be added to AbstractVersion.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (36, null, 'ADEOfAbstractVersionTransition', 1, 1, '{"identifier":"core:ADEOfAbstractVersionTransition","description":"ADEOfAbstractVersionTransition acts as a hook to define properties within an ADE that are to be added to AbstractVersionTransition.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (37, null, 'ADEOfCityModel', 1, 1, '{"identifier":"core:ADEOfCityModel","description":"ADEOfCityModel acts as a hook to define properties within an ADE that are to be added to a CityModel.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (38, null, 'ADEOfClosureSurface', 1, 1, '{"identifier":"core:ADEOfClosureSurface","description":"ADEOfClosureSurface acts as a hook to define properties within an ADE that are to be added to a ClosureSurface.","table":"property"}');
...
INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (101, null, 'TimeseriesComponent', 0, 2, '{"identifier":"dyn:TimeseriesComponent","description":"TimeseriesComponent represents an element of a CompositeTimeseries.","table":"property","properties":[{"name":"repetitions","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies how often the timeseries that is referenced by the TimeseriesComponent should be iterated.","type":"core:Integer","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"additionalGap","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies how much extra time is added after all repetitions as an additional gap.","type":"core:String","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"timeseries","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Relates a timeseries to the TimeseriesComponent.","type":"core:FeatureProperty","target":"dyn:AbstractTimeseries","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}}]}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (102, null, 'TimeValuePair', 0, 2, '{"identifier":"dyn:TimeValuePair","description":"A TimeValuePair represents a value that is valid for a given point in time. For each TimeValuePair, only one of the value properties can be used mutually exclusive. Which value property has to be provided depends on the selected value type in the GenericTimeSeries feature, in which the TimeValuePair is included.","table":"property","properties":[{"name":"timestamp","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the timepoint at which the value of the TimeValuePair is valid.","type":"core:Timestamp","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"intValue","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the Integer value of the TimeValuePair.","type":"core:Integer","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"doubleValue","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the Double value of the TimeValuePair.","type":"core:Double","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"stringValue","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the String value of the TimeValuePair.","type":"core:String","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"geometryValue","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the geometry value of the TimeValuePair.","type":"core:GeometryProperty","target":"core:AbstractGeometry","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"uriValue","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the URI value of the TimeValuePair.","type":"core:URI","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"boolValue","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the Boolean value of the TimeValuePair.","type":"core:Boolean","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"implicitGeometryValue","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the ImplicitGeometry value of the TimeValuePair.","type":"core:ImplicitGeometryProperty","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}},{"name":"appearanceValue","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the Appearance value of the TimeValuePair.","type":"core:AppearanceProperty","join":{"table":"property","fromColumn":"id","toColumn":"parent_id"}}]}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (103, null, 'ADEOfAbstractAtomicTimeseries', 1, 2, '{"identifier":"dyn:ADEOfAbstractAtomicTimeseries","description":"ADEOfAbstractAtomicTimeseries acts as a hook to define properties within an ADE that are to be added to AbstractAtomicTimeseries.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (104, null, 'ADEOfAbstractTimeseries', 1, 2, '{"identifier":"dyn:ADEOfAbstractTimeseries","description":"ADEOfAbstractTimeseries acts as a hook to define properties within an ADE that are to be added to AbstractTimeseries.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (105, null, 'ADEOfCompositeTimeseries', 1, 2, '{"identifier":"dyn:ADEOfCompositeTimeseries","description":"ADEOfCompositeTimeseries acts as a hook to define properties within an ADE that are to be added to a CompositeTimeseries.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (106, null, 'ADEOfDynamizer', 1, 2, '{"identifier":"dyn:ADEOfDynamizer","description":"ADEOfDynamizer acts as a hook to define properties within an ADE that are to be added to a Dynamizer.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (107, null, 'ADEOfGenericTimeseries', 1, 2, '{"identifier":"dyn:ADEOfGenericTimeseries","description":"ADEOfGenericTimeseries acts as a hook to define properties within an ADE that are to be added to a GenericTimeseries.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (108, null, 'ADEOfStandardFileTimeseries', 1, 2, '{"identifier":"dyn:ADEOfStandardFileTimeseries","description":"ADEOfStandardFileTimeseries acts as a hook to define properties within an ADE that are to be added to a StandardFileTimeseries.","table":"property"}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (109, null, 'ADEOfTabulatedFileTimeseries', 1, 2, '{"identifier":"dyn:ADEOfTabulatedFileTimeseries","description":"ADEOfTabulatedFileTimeseries acts as a hook to define properties within an ADE that are to be added to a TabulatedFileTimeseries.","table":"property"}');
