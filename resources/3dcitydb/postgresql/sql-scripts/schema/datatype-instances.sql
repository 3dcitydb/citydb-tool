...
INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (110, 100, 'TimeString', 0, 2, '{"identifier":"dyn:TimeString","description":"TimeString represents a string value that is valid for a given timepoint.","table":"property","properties":[{"name":"value","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the string value at the given timepoint.","type":"core:String"}]}');

INSERT INTO datatype (ID, SUPERTYPE_ID, TYPENAME, IS_ABSTRACT, NAMESPACE_ID, SCHEMA)
VALUES (111, 100, 'TimeURI', 0, 2, '{"identifier":"dyn:TimeURI","description":"TimeURI represents a URI value that is valid for a given timepoint.","table":"property","properties":[{"name":"value","namespace":"http://3dcitydb.org/3dcitydb/dynamizer/5.0","description":"Specifies the URI value at the given timepoint.","type":"core:URI"}]}');
